...
<div className="flex relative w-full md:h-[450px] h-[200px] p-4 border rounded shadow overflow-hidden bg-white">
    <Image alt="Live chat" src="/static/images/active_support.svg" fill={true} className=" object-contain -mt-0 " />
</div>
...
<div className="flex relative w-full md:h-[450px] h-[200px] p-4 border rounded shadow overflow-hidden bg-white">
    <Image alt="decision" src="/static/images/think.svg" fill={true} className=" object-contain -mt-0 " />
</div>
